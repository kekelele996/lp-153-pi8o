...
const (
	...
	MsgClaimSubmitted         = "已提交完成，等待发布者确认"
	MsgClaimApproved          = "验收通过，心愿已完成"
	MsgClaimRejected          = "已退回，圆梦人调整后可重新提交"
	...
	MsgClaimNotPendingConfirm = "该心愿不在待确认状态，无法验收"
	MsgClaimConfirmLocked     = "心愿正等待发布者确认，请先等待验收结果"
	MsgRejectReasonRequired   = "退回时必须填写原因"
